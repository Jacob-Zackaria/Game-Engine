...
namespace Azul
{
	GraphicsObject_Sprite::GraphicsObject_Sprite(Model *model, ShaderObject *pShaderObj, Image *_pImage, Rectangle rect)
	...
	{
		// Get camera
		//Camera *pCam = CamerasManager::GetCurrent(Camera::Type::ORTHOGRAPHIC_2D);
