...
#define SPHERE_DATA_NUM_VERTS (sizeof(pVerts)/sizeof(Vert_xyzuvn))
		...
		Vert_xyzuvn pVerts[9] = { 0 };
		Tri_index triList[8] = { 0 };
		...
		Camera *pCam = CamerasManager::Find(Camera::Name::CAMERA_0);
		pCam->updateCamera();

		pCam->getPos(vTmp);
		pVerts[0].x = vTmp[x_enum::x];
		pVerts[0].y = vTmp[y_enum::y];
		pVerts[0].z = vTmp[z_enum::z];
		pVerts[0].nx = 0.000000f;
		pVerts[0].ny = 0.000000f;
		pVerts[0].nz = 0.000000f;
		pVerts[0].u = 0.000000f;
		...
		pVerts[1].x = vTmp[x_enum::x];
		pVerts[1].y = vTmp[y_enum::y];
		pVerts[1].z = vTmp[z_enum::z];
		...
		pVerts[2].x = vTmp[x_enum::x];
		pVerts[2].y = vTmp[y_enum::y];
		pVerts[2].z = vTmp[z_enum::z];
		...
		pVerts[3].x = vTmp[x_enum::x];
		pVerts[3].y = vTmp[y_enum::y];
		pVerts[3].z = vTmp[z_enum::z];
		...
		pVerts[4].x = vTmp[x_enum::x];
		pVerts[4].y = vTmp[y_enum::y];
		pVerts[4].z = vTmp[z_enum::z];
		...
		pVerts[5].x = vTmp[x_enum::x];
		pVerts[5].y = vTmp[y_enum::y];
		pVerts[5].z = vTmp[z_enum::z];
		...
		pVerts[6].x = vTmp[x_enum::x];
		pVerts[6].y = vTmp[y_enum::y];
		pVerts[6].z = vTmp[z_enum::z];
		...
		pVerts[7].x = vTmp[x_enum::x];
		pVerts[7].y = vTmp[y_enum::y];
		pVerts[7].z = vTmp[z_enum::z];
		...
		pVerts[8].x = vTmp[x_enum::x];
		pVerts[8].y = vTmp[y_enum::y];
		pVerts[8].z = vTmp[z_enum::z];
