...
//    v.3.45  - bug in release
//----------------------------------------------------------------------------- 

#ifndef FRAMEWORK_H
#define FRAMEWORK_H

#define FRAMEWORK_VER "3.45"
...
#define UNIT_TEST_CPP_H
		...
		{
		public:
			static bool AreEqual(const float a, const float b, float epsilon = 0.001f) 
			{
				return (fabs(a-b) < epsilon);
			}

			static bool AreEqual(double a, double b, double epsilon = 0.001) noexcept
			{
